...
# backup old .apk
cp /workspace/appCBBr/public/$wow4-app-debug.apk /workspace/my-gitpod-dockerfile-cordova/public/$wow4-backup-app-debug.apk

#copy new .apk to the public folder
cp /workspace/appCBBr/$wow4/platforms/android/app/build/outputs/apk/debug/app-debug.apk /workspace/appCBBr/public/$wow4-app-debug.apk
...
echo "<li> Next rebuild <a href="$wow4-app-debug.apk">$wow4-app-debug.apk</a><br>" >> /workspace/appCBBr/public/index.html
