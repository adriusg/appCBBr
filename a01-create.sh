...
cp /workspace/my-gitpod-dockerfile-cordova/$wow4/platforms/android/app/build/outputs/apk/debug/app-debug.apk /workspace/appCBBr/public/$wow4-app-debug.apk



qrcode -o /workspace/appCBBr/public/qrout.png $(gp url 8001);
echo "<br><img src='qrout.png'><br>" >> /workspace/appCBBr/public/index.html
...
echo "<li><a href="$wow4-app-debug.apk">$wow4-app-debug.apk</a><br>" >> /workspace/appCBBr/public/index.html
